# https://www.amazon.com/gp/most-wished-for/home-garden/381142011/ref=zg_bs_tab_t_home-garden_mw
import os
...
drive.get(
    r'https://www.amazon.com/gp/most-wished-for/home-garden/381142011/ref=zg_bs_tab_t_home-garden_mw')  # 跳转到亚马逊
x = 1  # 定义一个计数器给图片命名并计数
for i in range(1, 3):
    drive.wait(2)  # 等待网页加载
    ...
    path = r'C:\Users\Administrator\Desktop\Amz_Most'  # 自定义路径,存放这个排行榜的图片
    ...
    drive.get('https://www.amazon.com/gp/most-wished-for/home-garden/381142011/ref=zg_mw_pg_2_home-garden?ie=UTF8&pg=2')
